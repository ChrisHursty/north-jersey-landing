...
const Index = () => {
  ...
  return <div className="min-h-screen">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Button size="lg" className="bg-[#300954] hover:bg-[#300954]/90 text-white px-8 py-4 text-lg" onClick={() => scrollToSection('contact')}>
            ...
            <Card className="bg-white/95 backdrop-blur-sm">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <select className="w-full p-3 border rounded-md" value={formData.service} onChange={e => setFormData({
                  ...formData,
                  ...
                  <Textarea placeholder="Describe your project..." value={formData.message} onChange={e => setFormData({
                  ...formData,
      ...
      <section id="gallery" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            location: "Passaic"
          }].map((project, index) => <Card key={index} className="overflow-hidden hover:shadow-lg transition-shadow">
      ...
      <section className="py-20 bg-[#300954] text-white">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <Button size="lg" className="bg-white text-[#300954] hover:bg-gray-100 px-12 py-4 text-xl" onClick={() => scrollToSection('contact')}>
      ...
      {/* Mobile Sticky CTA */}
      <div className={`fixed bottom-0 left-0 right-0 z-50 bg-[#300954] text-white p-4 transform transition-transform md:hidden ${showMobileCTA ? 'translate-y-0' : 'translate-y-full'}`}>
        <div className="flex items-center justify-between">
          <div>
            <div className="font-bold">Save 15% Today!</div>
            <div className="text-sm opacity-90">Limited time offer</div>
          </div>
          <Button className="bg-white text-[#300954] hover:bg-gray-100 font-bold" onClick={() => scrollToSection('contact')}>
            Get Quote Now
          </Button>
        </div>
      </div>
